...
In this hands-on exercise, we will delineate homogeneous region by using geographically referenced multivariate data. There are two major analysis, namely:
...
#### 1.7.2.2 Z-score standardization
...
### 1.7.3 Visualizing the standardized clustering variables
...
### 1.7.4 Computing proximity matrix
...
### 1.7.5 Computing hierarchical clustering
...
### 1.7.6 Selecting the optimal clustering algorithm
...
### 1.7.7 Determining Optimal Clusters
...
### 1.7.8 Interpreting the Dendrograms
...
### 1.7.9 Visually-driven hierarchical clustering analysis
...
#### 1.7.9.1 Transforming the data frame into a matrix
...
#### 1.7.9.2 Plotting interactive cluster heatmap using *heatmaply()*
...
### 1.7.10 Mapping the clusters formed
...
### 1.8.3 Computing Minimum Spanning Tree
...
### 1.8.4 Computing spatially constrained clusters using SKATER method
...
### 1.8.5 Visualizing the clusters
...
### 1.9.1 Ward-like hierarchical clustering: ClustGeo
...
#### 1.9.1.1 Mapping the clusters formed
